...
const dict = {
  ...
  "fac.tours": ["格安ツアーパッケージ (₹25,000〜)","Affordable Tour Packages (from ₹25,000)"],
  "fac.tourprice": ["🚕 インド周遊ツアー ₹25,000〜 今すぐ予約","🚕 India tour packages from ₹25,000 · Book now"],
  "tour.cta": ["ツアーを予約しよう！","Book a tour now!"],
  "tour.sub": ["ワンクリックでインドの魅力を体験 · ₹25,000〜","Experience the wonders of India in one click · from ₹25,000"],
